...
export const MainLayout: React.FC<IPageLayoutProps> = ({
  footer,
  children
}) => {
  return (
    <div>
      <div className='header'>
        ...
        >
          ...
          <Grid item md={2} xs={12} className='button-container'>
            <Button variant='outlined' color='secondary'>SignOut</Button>
          </Grid>
        </Grid>
      </div>
      <div className='main'>
